...
# PRESENT Cipher related functions
...
def pad_with_zeros(string, length):
    """Manually pad string with leading zeros."""
...
def generateRoundKeys(key):
    K = []
    string = bin(key)[2:]
    string = pad_with_zeros(string, 80)
